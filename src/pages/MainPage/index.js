		...
		<div className="">
					...
					<div className="flex gap-x-[8px] flex-nowrap overflow-x-hidden w-full">
						{
							haksa.map((item) => (
								<div>
								<div className="w-[250px] h-[120px] bg-[#1C1C1C] rounded-[8px] text-[#E7E7E5] flex flex-col justify-center gap-[12px] p-[8px]">
			...
			<div className="mt-[40px] mx-[200px]">
				...
				<main>
					{
						content.map((item) => (
							<div className="w-[250px] h-[230px] bg-[#1C1C1C] rounded-[8px] text-[#E7E7E5] px-[14px] pt-[14px]">
